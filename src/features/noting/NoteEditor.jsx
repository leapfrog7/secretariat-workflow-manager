  ...
  return (
    <div ref={editorShellRef} className="overflow-hidden rounded-md border border-slate-300 bg-white shadow-sm transition-shadow focus-within:border-slate-400 focus-within:ring-1 focus-within:ring-slate-200">
      ...
      <div className="relative w-full">
        {!readOnly && editor.isEmpty && <div className="note-editor-placeholder pointer-events-none absolute left-5 top-5 font-serif text-[12pt] text-slate-400 sm:left-8 sm:top-7">Record the examination, reasoning and proposed course…</div>}
        <EditorContent
          editor={editor}
