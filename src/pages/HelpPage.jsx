        ...
        <div className="min-w-0 space-y-5" style={{ overflowWrap: 'anywhere' }}>
          ...
          <HelpSection id="workspace" icon={FileText} title="Inside an Issue" tone="amber">
            ...
            <div className="divide-y divide-slate-200 border-y border-slate-200">
              <WorkspaceRow icon={History} title="Current Position">Update the stage (Pending, In Progress, Awaiting Input, Awaiting Discussion, Completed, Cancelled or Deferred), assignment and latest position. Every saved position becomes a dated milestone instead of replacing history. The latest five appear first; open the earlier history when needed.</WorkspaceRow>
              ...
              <WorkspaceRow icon={FileText} title="Noting">Record the chronological examination of the case with lists or tables, optional appendix material and links to communications or references. Use Local or Cloud AI to generate or refine wording for review. Notes remain editable after discussion, while every saved edit keeps the earlier wording in version history. Select Draft on a note to use it as drafting context.</WorkspaceRow>
              <WorkspaceRow icon={Bot} title="Drafting">Prepare an official communication, choose the summary, communications, references and notes supplied to AI, reuse approved wording from the Paragraph Bank, save routine changes or preserve a separate version, and record the final outgoing communication.</WorkspaceRow>
          ...
          <HelpSection id="ai" icon={Bot} title="Preparing an AI-assisted draft" tone="violet">
            <GuideLocation link="/issues" label="Choose an Issue">Issue workspace &gt; Drafting</GuideLocation>
            <ol className="space-y-3">
              ...
              <Instruction number="4" title="Select sources deliberately">In Drafting, select Draft Settings and open the AI context tab. Choose the summary, communications, references and notes needed for the communication. Sensitive or irrelevant entries can remain unselected.</Instruction>
              ...
              <Instruction number="6" title="Choose or change the format">Select Draft Settings and choose Office Memorandum, D.O. Letter, Letter, Office Order, Order, I.D. Note or another available form. Start blank writes without AI and Generate with AI prepares a new body. For an open structured draft, Change draft type rebuilds only the official format and preserves the existing body.</Instruction>
