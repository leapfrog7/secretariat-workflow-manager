        ...
        <div className="min-w-0 space-y-5" style={{ overflowWrap: 'anywhere' }}>
          ...
          <HelpSection id="workspace" icon={FileText} title="Inside an Issue" tone="amber">
            ...
            <div className="divide-y divide-slate-200 border-y border-slate-200">
              ...
              <WorkspaceRow icon={FileText} title="Casework: Examine and Note">Open Casework from the main navigation and search for an Issue by title, eFile number or present position. From an open Issue, use Open Casework in the page header. Recent returns to saved Notes and Drafts; Awaiting lists matters awaiting input or discussion. In large cloud workspaces search is paged on the server and automatically falls back to the synchronized local copy when offline. Record the chronological examination with lists or tables. Select a sentence or paragraph and choose Rewrite selection when only that passage needs improvement. Open Source material below the editor to use the running summary, linked records, an appendix, or a Word, text or PDF document. Help me write uses a short menu for preparing or improving the complete note; provider and model choices remain under Advanced settings. Selectable PDF text is extracted directly, while scanned pages can be read locally with English, Hindi or bilingual OCR. Choose only relevant pages and review the editable text before sending it to AI. Files are processed in browser memory and are not uploaded or stored. Notes remain editable after discussion, while earlier wording stays in history.</WorkspaceRow>
              <WorkspaceRow icon={Bot} title="Casework: Prepare Communication">Select Prepare communication on a Note to carry that Note, its linked records, the running summary and current position into Drafting. Start blank draft opens the editor immediately. Prepare with AI opens one brief-and-context step before generating. In the editor, select body text before using Rewrite selection; use More and Prepare again with AI only when a new full draft is required.</WorkspaceRow>
          ...
          <HelpSection id="ai" icon={Bot} title="Preparing an AI-assisted draft" tone="violet">
            ...
            <ol className="space-y-3">
              ...
              <Instruction number="6" title="Choose or change the format">Choose Office Memorandum, D.O. Letter, Letter, Office Order, Order, I.D. Note or another available form. Start blank draft opens the official structure without AI. Prepare with AI lets you choose the provider, complexity, optional Note and factual context before generation. Advanced settings lets you add your own drafting direction and review the exact prompt and approximate token size before sending it; protected factual and formatting rules remain read-only. In an open draft, change the format through the Details side tool; the substantive body is preserved.</Instruction>
