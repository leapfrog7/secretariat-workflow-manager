        ...
        <div className="min-w-0 space-y-5" style={{ overflowWrap: 'anywhere' }}>
          ...
          <HelpSection id="workspace" icon={FileText} title="Inside an Issue" tone="amber">
            ...
            <div className="divide-y divide-slate-200 border-y border-slate-200">
              ...
              <WorkspaceRow icon={Bot} title="Casework: Prepare Communication">Select Prepare communication on a Note to carry that Note, its linked records, the running summary and current position into Drafting. Choose what you are preparing, then Start writing or Create first draft with AI. Complete addressee details while drafting, reuse the Paragraph Bank, download Word and record the communication as issued.</WorkspaceRow>
          ...
          <HelpSection id="ai" icon={Bot} title="Preparing an AI-assisted draft" tone="violet">
            ...
            <ol className="space-y-3">
              ...
              <Instruction number="6" title="Choose or change the format">Choose Office Memorandum, D.O. Letter, Letter, Office Order, Order, I.D. Note or another available form. Start writing opens the official structure without AI; Create first draft with AI prepares the body. For an open draft, use More and Change communication type to preserve the body while rebuilding the official format.</Instruction>
