        ...
        <div className="min-w-0 space-y-5" style={{ overflowWrap: 'anywhere' }}>
          ...
          <HelpSection id="workspace" icon={FileText} title="Inside an Issue" tone="amber">
            ...
            <div className="divide-y divide-slate-200 border-y border-slate-200">
              ...
              <WorkspaceRow icon={FileText} title="Casework: Examine and Note">Record the chronological examination of the case with lists or tables. Appendix material and links to communications or references are available under Supporting material. Help me write offers plain-language AI actions and can use an optional Markdown file for the current request. Notes remain editable after discussion, while earlier wording stays in history.</WorkspaceRow>
