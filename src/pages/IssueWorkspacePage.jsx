...
export default function IssueWorkspacePage() {
  ...
  return (
    <>
      ...
      {state.activeTab === 'AI Context' && <AIContextPreview issue={issue} assignedOfficer={assignedOfficer} officers={officers} summary={state.latestSummary} communications={state.communications} references={state.references} />}
