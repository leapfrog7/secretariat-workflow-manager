...
export default function SyncStatusPanel() {
  ...
  return (
    <div className="relative">
      ...
      {open && (
        <section ref={panelRef} aria-label="Cloud synchronization" className="popover-enter fixed inset-x-3 top-16 z-50 max-h-[calc(100dvh-5rem)] origin-top-right overflow-y-auto rounded-md border border-slate-200 bg-white shadow-xl sm:absolute sm:inset-x-auto sm:right-0 sm:top-10 sm:w-[min(calc(100vw-1.5rem),22rem)] sm:max-h-[calc(100dvh-4.5rem)]">
